...
const jobs: JobRecord[] = [
  {
    ...
    pickupAddress: 'Khalifa Port, Abu Dhabi, UAE',
    deliveryAddress: 'Warehouse 8B, Mussafah, Abu Dhabi, UAE',
  ...
  },
  {
    ...
    pickupAddress: 'Khor Fakkan Port, Sharjah, UAE',
    deliveryAddress: 'Industrial Area 3, Plot 42, Al Quoz, Dubai, UAE',
  ...
  },
  {
    ...
    pickupAddress: 'Mina Saqr, Ras Al Khaimah, UAE',
    deliveryAddress: 'Dubai Investments Park 2, Logistics Gate 4, Dubai, UAE',
  ...
  },
  {
    ...
    pickupAddress: 'Fujairah Port, Fujairah, UAE',
    deliveryAddress: 'Plot 18, DIP 1, Dubai, UAE',
